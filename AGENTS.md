...
- **GitHub review conversations**: When asked to address feedback from a GitHub PR review (e.g. Copilot), fix the issue in code, then reply to the review comment on GitHub explaining what was changed. If the PR URL wasn't provided, ask for it. Use `gh api` to reply to the comment and resolve the conversation.
